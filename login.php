...
<form action="http://uherederosw1617.hol.es/labAJAX/login.php" method="post" accept-charset="UTF-8"> 
...
if(isset($_POST["password"]))
	...
	if ($connect) {
		...
		if($contador==1){
			...
			header('Location: http://uherederosw1617.hol.es/labAJAX/PaginaLogin.php');
		}
		else{
